...
<section class="section-header jumbotron">
    <div class="container row">
        ...
        data-aos-duration="500">
            ...
            <div class="subtitle-header" style="color: #b0b0b9;">
            ...
            <div class="row">
                ...
                data-aos-duration="1000">
                    ...
                    <p class="mt-1">{{ $house }}<span style="color: #b0b0b9;"> House</span></p>
                </div>
                <div class="icon-sets col-lg-3 col-md-3 col-sm-2 mt-5 text-center" data-aos="fade-up"
                data-aos-duration="1200">
                    <i class="fas fa-map-marker-alt fa-md"></i>
                    <p class="mt-1">7<span style="color: #b0b0b9;">  Cities</span></p>
                </div>
                <div class="icon-sets col-lg-3 col-md-3 col-sm-2 mt-5 text-center" data-aos="fade-up"
                data-aos-duration="1400">
                    <i class="fas fa-road fa-md"></i>
                    <p class="mt-1">4<span style="color: #b0b0b9;">  Nearby</span></p>
                </div>
            </div>
        </div>
...
<section class="section-most-picked" id="show">
        ...
        <div class="most-content" data-aos="fade-up" data-aos-delay="200">
            @for ($i = 0; $i < 1; $i++)
            <div class="most-img" style="background-image: url('{{$most_header[$i]->galleries->count() ? Storage::url($most_header[$i]->galleries->first()->image):''}}');">
            ...
            <div class="most-img-option">
                <div class="img-1" style="background-image: url('{{$most_header[1]->galleries->count() ? Storage::url($most_header[1]->galleries->first()->image):''}}');" data-aos="fade-up" data-aos-delay="300">
                ...
                <div class="img-2" style="background-image: url('{{$most_header[2]->galleries->count() ? Storage::url($most_header[2]->galleries->first()->image):''}}');" data-aos="fade-up" data-aos-delay="400">
                ...
                <div class="img-3" style="background-image: url('{{$most_header[3]->galleries->count() ? Storage::url($most_header[3]->galleries->first()->image):''}}');" data-aos="fade-up" data-aos-delay="500">
                ...
                <div class="img-4" style="background-image: url('{{$most_header[4]->galleries->count() ? Storage::url($most_header[4]->galleries->first()->image):''}}');" data-aos="fade-up" data-aos-delay="600">
